...
from pigar._vendor.pip._internal.req.req_file import COMMENT_RE
from pigar._vendor.pip._internal.utils.direct_url_helpers import direct_url_as_pep440_direct_reference
...
def _get_editable_info(dist: BaseDistribution) -> _EditableInfo:
    ...
    from pigar._vendor.pip._internal.vcs import RemoteNotFoundError, RemoteNotValidError, vcs
