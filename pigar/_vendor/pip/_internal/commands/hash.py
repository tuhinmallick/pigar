...
from pigar._vendor.pip._internal.utils.hashes import FAVORITE_HASH, STRONG_HASHES
from pigar._vendor.pip._internal.utils.misc import read_chunks, write_output
