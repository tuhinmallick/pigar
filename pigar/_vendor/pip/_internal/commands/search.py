...
from pigar._vendor.pip._internal.cli.status_codes import NO_MATCHES_FOUND, SUCCESS
...
from pigar._vendor.pip._internal.network.xmlrpc import PipXmlrpcTransport
