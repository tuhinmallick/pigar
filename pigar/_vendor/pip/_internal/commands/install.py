...
from pigar._vendor.pip._internal.cli.req_command import (
    RequirementCommand,
    warn_if_run_as_root,
    with_cleanup,
)
...
from pigar._vendor.pip._internal.operations.check import ConflictDetails, check_install_conflicts
...
from pigar._vendor.pip._internal.utils.virtualenv import (
