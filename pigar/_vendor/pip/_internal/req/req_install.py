...
from pigar._vendor.pip._internal.metadata.base import FilesystemWheel
...
from pigar._vendor.pip._internal.operations.build.metadata import generate_metadata
from pigar._vendor.pip._internal.operations.build.metadata_editable import generate_editable_metadata
from pigar._vendor.pip._internal.operations.build.metadata_legacy import (
    generate_metadata as generate_metadata_legacy,
)
from pigar._vendor.pip._internal.operations.install.editable_legacy import (
    install_editable as install_editable_legacy,
)
from pigar._vendor.pip._internal.operations.install.wheel import install_wheel
from pigar._vendor.pip._internal.pyproject import load_pyproject_toml, make_pyproject_path
from pigar._vendor.pip._internal.req.req_uninstall import UninstallPathSet
from pigar._vendor.pip._internal.utils.deprecation import deprecated
...
from pigar._vendor.pip._internal.utils.packaging import safe_extra
from pigar._vendor.pip._internal.utils.subprocess import runner_with_spinner_message
